    ...
    const fetchActivities = async () => {
        try {
            ...
            if (res.ok) {
                ...
                setTotalPagesCompleted(Math.ceil(allCompleted.length / COMPLETED_ACTIVITIES_PER_PAGE));
            ...
            <div className="flex flex-col items-center gap-6">
                {upcoming.length > 0 ? (
                    upcoming.map((activity) => (
                        <div key={activity._id} className="w-full max-w-xl">
                             <ActivityCard
                                activity={activity}
